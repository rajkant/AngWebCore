...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._httpService.get('/api/values/GetDropDown').subscribe(function (values) {
            _this.apiValues = values.json();
        });
        this._httpService.get('/api/values/GetRoutingNums?test=test').subscribe(function (values) {
            _this.rowData = values.json();
        });
    };
    AppComponent.prototype.onClickSubmit = function (datain) {
        var req = this._httpService.post('/api/values/Post', {
            datain: datain
        })
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                ag_grid_angular__WEBPACK_IMPORTED_MODULE_3__["AgGridModule"].withComponents(null),
...
module.exports = __webpack_require__(/*! C:\Users\rajanikant.singh\Documents\Visual Studio 2017\Projects\AngWeb\AngWeb\src\main.ts */"./src/main.ts");
